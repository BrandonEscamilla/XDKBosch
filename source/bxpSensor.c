...
void Sensor_sendStreamDataTimerHandler(xTimerHandle pvParameters)
{
	...
	g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"sn\": \"%s\",\n",  CFG_getMqttClientId());
	g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"data\": {\n");
	if (CFG_isAccelEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"acc\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"x\": %ld,\n", _accelBMA280Data.xAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"y\": %ld,\n", _accelBMA280Data.yAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"z\": %ld,\n", _accelBMA280Data.zAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"mG\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isGyroEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"gyro\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"x\": %ld,\n", _gyroBMG160Data.xAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"y\": %ld,\n", _gyroBMG160Data.yAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"z\": %ld,\n", _gyroBMG160Data.zAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"mdeg/s\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isMagEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"mag\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"x\": %ld,\n", _magData.xAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"y\": %ld,\n", _magData.yAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"z\": %ld,\n", _magData.zAxisData);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"uT\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isLightEnabled() == CFG_ENABLED) {
	    g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"light\": {\n");
	    g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"value\": %ld,\n", _lgtData);
	    g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"mLux\"\n");
	    g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isTempEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"temp\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"value\": %ld,\n", _envData.temperature);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"mCelsius\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isPresEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"pressure\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"value\": %ld,\n", _envData.pressure);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"Pascal\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	if (CFG_isHumEnabled() == CFG_ENABLED) {
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"humidity\": {\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"value\": %ld,\n", _envData.humidity);
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "\"unit\": \"%%rh\"\n");
		g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + g_sensorStreamBuffer.length, "},\n");
	}
	g_sensorStreamBuffer.length += sprintf(g_sensorStreamBuffer.data + (g_sensorStreamBuffer.length - 2), "\n}\n}\n");
...
void Sensor_sendReportData(void)
{
	...
	g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"sn\": \"%s\",\n",  CFG_getMqttClientId());
	g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"data\": {\n");
	if (CFG_isAccelEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"acc\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"x\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorAccelDataX.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorAccelDataX.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld\n", s_sensorAccelDataX.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"y\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorAccelDataY.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorAccelDataY.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld\n", s_sensorAccelDataY.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"z\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorAccelDataZ.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorAccelDataZ.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld\n", s_sensorAccelDataZ.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"mG\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isGyroEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"gyro\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"x\": {\n");
		...
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"mdeg/s\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isMagEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"mag\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"x\": {\n");
		...
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"uT\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isLightEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"light\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorLightData.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorLightData.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld,\n", s_sensorLightData.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"mLux\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isTempEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"temp\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorTempData.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorTempData.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld,\n", s_sensorTempData.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"mCelsius\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isPresEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"pressure\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorPressureData.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorPressureData.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld,\n", s_sensorPressureData.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"Pascal\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	if (CFG_isHumEnabled() == CFG_ENABLED) {
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"humidity\": {\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"min\": %ld,\n", s_sensorHumidityData.Min);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"max\": %ld,\n", s_sensorHumidityData.Max);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"avg\": %ld,\n", s_sensorHumidityData.Avg);
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "\"unit\": \"%%rh\"\n");
		g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + g_sensorReportBuffer.length, "},\n");
	}
	g_sensorReportBuffer.length += sprintf(g_sensorReportBuffer.data + (g_sensorReportBuffer.length - 2), "\n}\n}\n");
	g_sensorReportBuffer.length -= 2;
